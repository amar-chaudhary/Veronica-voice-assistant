...
def wishme():
    speak("Welcome back Amar chaudhary")
    time_()
    date()
    ...
    speak("Veronica at your service. Please tell me how can I help you?")
...
def sendEmail(to, content):
    ...
    server.login('jameschy551@gmail', 'amarkc551@')
    server.sendmail('jameschy551@gmail', to, content)
    server.close()
...
def Introduction():
    speak("I am VERONICA 1.0 , Personal AI assistant , "
    "I am created by AMAR CHAUDHARY , "
...
def Creator():
    speak("AMAR is an extra-ordinary person ,"
    "He has a passion for Artificial Intelligence and Machine Learning ,"
    "He is very co-operative ,"
    "If you are facing any problem regarding the 'Veronica', He will be glad to help you ")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("Thanks to Amar. further it is a secret")
        elif 'word' in query:
            speak("opening MS Word")
            word = r'C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft Office 2013\Word 2013'
            os.startfile(word)

        elif 'what is love' in query or 'tell me about love' in query:
            speak("It is 7th sense that destroy all other senses , "
            "And I think it is just a mere illusion , "
            "It is waste of time . My Creator hates love . So if you are around him , "
            "Don't talk about True love at all")
        ...
        elif 'remember that' in query or 'remember something' in query:
            ...
            api_key = "139db448b4602e8a360a7021c2d063e9"
            ...
            try:
                ...
                jsonObj = urlopen('''https://newsapi.org/v2/everything?q=corona&from=2021-04-12&sortBy=publishedAt&apiKey=923ac9a34acf4a0293a251acbbd5d01f''')
            ...
            Introduction()
        elif 'tell me about Amar' and 'creator' in query:
            Creator()
            ...
            speak("It's hard to understand, I am still trying to figure this out. Its more complicate than me.")
        

        elif "calculate" in query:
            
            app_id = "4HEG93-7GHT9GX9WH"
            ...
            client = wolframalpha.Client("4HEG93-7GHT9GX9WH")
            ...
            speak("I have been created by Amar.")
        

        elif 'nepal flag in code' in query:
            speak("Enter number of rows:")
